        ...
        if (imagenSeleccionadaUri != null) {
            ...
            inventoryManager.subirImagen(imagenSeleccionadaUri!!, object : FirebaseInventoryManager.ImageUploadCallback {
                override fun onUrlLoaded(url: String) {
                    guardarProductoFinal(nombre, desc, precio, url, categoria, plataforma, estadoStock)
                }
            ...
            guardarProductoFinal(nombre, desc, precio, juegoAEditar?.imagenUrl ?: "", categoria, plataforma, estadoStock)
        }
    }
